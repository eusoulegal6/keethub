        ...
        <div className="flex items-center justify-between flex-wrap gap-2 sm:gap-4">
            ...
            {isGameActive && (
              <>
                {isDrawer ? (
                  <Badge
                    variant="secondary"
                    className="text-xs sm:text-sm md:text-lg px-2 sm:px-3 py-1 flex items-center gap-1 sm:gap-2"
                  >
                  ...
                  <Badge
                    variant="outline"
                    className="text-xs sm:text-sm md:text-lg px-2 sm:px-3 py-1 flex items-center gap-1 sm:gap-2 bg-background/20 text-primary-foreground border-primary-foreground/30"
                  >
          ...
          {isGameActive && gameState.phase === "drawing" && (
            <div className="flex items-center gap-2 sm:gap-4 flex-wrap">
              <div className="flex items-center gap-1 sm:gap-2 text-primary-foreground">
                <Timer
                  className={`w-4 h-4 sm:w-5 sm:h-5 ${timeLeft <= 10 ? "animate-pulse text-red-300" : ""}`}
                />
                <span
                  className={`text-base sm:text-lg md:text-xl font-bold ${timeLeft <= 10 ? "text-red-300" : ""}`}
                >
                  {formatTime(timeLeft)}
                </span>
              </div>
          ...
          {gameState.phase === "round-ended" && (
            <div className="flex items-center gap-2 sm:gap-4 flex-wrap">
              <Badge
                variant="secondary"
                className="text-xs sm:text-sm md:text-lg px-2 sm:px-4 py-1 sm:py-2 flex items-center gap-1 sm:gap-2"
              >
              ...
              {roundWinner && (
                <Badge
                  variant="default"
                  className="text-xs sm:text-sm md:text-lg px-2 sm:px-3 py-1 flex items-center gap-1 sm:gap-2 bg-yellow-500 text-yellow-950"
                >
